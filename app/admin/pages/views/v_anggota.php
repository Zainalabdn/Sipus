                                        ...
                                        <div class="modal-content" style="border-radius: 5px;">
                                            ...
                                            <form action="pages/function/Anggota.php?aksi=edit"
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label>Kelas <small style="color: red;">* Wajib
                                                                diisi</small></label>
                                                        <select class="form-control" name="kElas">
                                                            ...
                                                            <!-- X -->
                                                            <option value="X - Administrasi Perkantoran">X -
                                                                Administrasi Perkantoran</option>
                                                            <option value="X - Farmasi">X - Farmasi</option>
                                                            <option value="X - Perbankan">X - Perbankan</option>
                                                            <option value="X - Rekayasa Perangkat Lunak">X - Rekayasa
                                                                Perangkat Lunak</option>
                                                            <option value="X - Tata Boga">X - Tata Boga</option>
                                                            <option value="X - Teknik Kendaraan Ringan">X - Teknik
                                                                Kendaraan Ringan</option>
                                                            <option value="X - Teknik Komputer dan Jaringan">X - Teknik
                                                                Komputer dan Jaringan</option>
                                                            <option value="X - Teknik Sepeda Motor">X - Teknik Sepeda
                                                                Motor</option>
                                                            <!-- XI -->
                                                            <option disabled>------------------------------------------
                                                            </option>
                                                            <option value="XI - Administrasi Perkantoran">XI -
                                                                Administrasi Perkantoran</option>
                                                            <option value="XI - Farmasi">XI - Farmasi</option>
                                                            <option value="XI - Perbankan">XI - Perbankan</option>
                                                            <option value="XI - Rekayasa Perangkat Lunak">XI - Rekayasa
                                                                Perangkat Lunak</option>
                                                            <option value="XI - Tata Boga">XI - Tata Boga</option>
                                                            <option value="XI - Teknik Kendaraan Ringan">XI - Teknik
                                                                Kendaraan Ringan</option>
                                                            <option value="XI - Teknik Komputer dan Jaringan">XI -
                                                                Teknik Komputer dan Jaringan</option>
                                                            <option value="XI - Teknik Sepeda Motor">XI - Teknik Sepeda
                                                                Motor</option>
                                                            <!-- XII -->
                                                            <option disabled>------------------------------------------
                                                            </option>
                                                            <option value="XII - Administrasi Perkantoran">XII -
                                                                Administrasi Perkantoran</option>
                                                            <option value="XII - Farmasi">XII - Farmasi</option>
                                                            <option value="XII - Perbankan">XII - Perbankan</option>
                                                            <option value="XII - Rekayasa Perangkat Lunak">XII -
                                                                Rekayasa Perangkat Lunak</option>
                                                            <option value="XII - Tata Boga">XII - Tata Boga</option>
                                                            <option value="XII - Teknik Kendaraan Ringan">XII - Teknik
                                                                Kendaraan Ringan</option>
                                                            <option value="XII - Teknik Komputer dan Jaringan">XII -
                                                                Teknik Komputer dan Jaringan</option>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="kelas">
                            ...
                            <option value="XII - Teknik Komputer dan Jaringan">XII - Teknik Komputer dan Jaringan
                            </option>
