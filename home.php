...
<body class="h-screen flex flex-col bg-cover" style="background: url('https://res.cloudinary.com/db7a43dtr/image/upload/v1719319760/night-adventure-with-fairy-glowing-object-generative-ai_188544-12605_1_gtrcyx.jpg')">
        <div class="w-full h-full bg-black/50">
            ...
            <main class="container mx-auto mt-16 py-8 px-4 flex-grow">
                <h2 class="text-3xl font-bold text-center mb-8 text-white">Temukan Buku Anda!</h2>
                <div class="flex justify-center mb-8">
                    ...
                    <div>
                        <form action="search.php" method="GET">
                            <input type="text" name="q" placeholder="Enter book title" class="search-input" required>
